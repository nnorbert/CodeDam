...
export interface SetVarConfig extends Record<string, unknown> {
...
export function SetVarConfigForm({
    values,
    errors,
    onChange,
    variables,
}: ConfigFormProps<SetVarConfig> & { variables: VariableOption[] }) {
    return (
        <div>
...
// Validation function
export function validateSetVarConfig(values: SetVarConfig): ValidationErrors {
