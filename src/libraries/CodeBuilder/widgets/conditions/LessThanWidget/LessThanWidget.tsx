...
import LessThanComponent from "./component";

export class LessThanWidget extends GenericWidgetBase {
    ...
    public static getToolboxItemElement(): React.ReactNode {
        return <div title="Less Than" className="big-font">&lt;</div>;
    }
    ...
    render(): React.ReactNode {
        return <LessThanComponent widget={this} />;
    }
