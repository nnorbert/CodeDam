...
import type { GreaterOrEqualWidget } from "./GreaterOrEqualWidget";

const GreaterOrEqualComponent = ({ widget }: { widget: GreaterOrEqualWidget }) => {
    const deleteHandler = () => {
...
export default GreaterOrEqualComponent;
