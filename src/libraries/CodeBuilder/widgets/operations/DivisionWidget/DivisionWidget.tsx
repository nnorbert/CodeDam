...
import DivisionComponent from "./component";

export class DivisionWidget extends GenericWidgetBase {
    ...
    render(): React.ReactNode {
        return <DivisionComponent widget={this} />;
    }
    ...
    async evaluate(): Promise<number> {
        ...
        // Handle division by zero - return Infinity or -Infinity as JavaScript does
